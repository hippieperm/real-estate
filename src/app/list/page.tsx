...
import { Search, Filter, SlidersHorizontal, Grid, List, Heart } from "lucide-react"
              ...
              <div>
                ...
                <div className="mt-2 space-y-2">
                  <Input
                    ...
                    onChange={(e) => setFilters({ ...filters, min_monthly: +e.target.value })}
                  />
                  <Input
                    type="number"
                    placeholder="최대"
                    value={filters.max_monthly}
                    onChange={(e) => setFilters({ ...filters, max_monthly: +e.target.value })}
                  />
                </div>
              </div>
                          ...
                          <div className="flex justify-between items-start">
                            <div className="flex-1">
                              ...
                              <div className="text-sm mt-2">
                                전용 {formatArea(listing.exclusive_m2)} · 공급 {formatArea(listing.supply_m2)} · {listing.floor}층
                              </div>
